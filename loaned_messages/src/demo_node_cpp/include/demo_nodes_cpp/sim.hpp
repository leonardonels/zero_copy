...
public:
    ...
    /**
     * @brief Ottiene puntatore diretto ai dati (Zero-Copy) se disponibile nuovo frame
     * @param size Output: dimensione dati letti
     * @return Puntatore ai dati se nuovo frame letto, nullptr se nessun nuovo frame
     */
